...
class HumidityNode(Node):
    def __init__(self, sensor_id: str = "", initial_pose: dict | None = None, *args, **kwargs):
        ...
        self.pose_publisher = self.create_publisher(
            topic=f"sensor.envsensor.humidity.{self.sensor_id}.pose",
    ...
    def start(self):
        ...
        while True:
            ...
            print(f"[HumidityNode] Publishing to sensor.envsensor.humidity.{self.sensor_id}.pose: {msg_pose.model_dump()}")
            ...
            print(f"[HumidityNode] Publishing to sensor.envsensor.humidity.{self.sensor_id}: {msg_data.model_dump()}")
