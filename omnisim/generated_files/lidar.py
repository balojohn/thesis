...
class LiDARNode(Node):
    def __init__(self, sensor_id: str = "", initial_pose: dict | None = None, *args, **kwargs):
        ...
        self.pose_publisher = self.create_publisher(
            topic=f"sensor.lidar.{self.sensor_id}.pose",
    ...
    def start(self):
        ...
        while True:
            ...
            print(f"[LiDARNode] Publishing to sensor.lidar.{self.sensor_id}.pose: {msg_pose.model_dump()}")
            self.pose_publisher.publish(msg_pose)
            msg_data = LidarMessage(
            ...
            print(f"[LiDARNode] Publishing to sensor.lidar.{self.sensor_id}: {msg_data.model_dump()}")
