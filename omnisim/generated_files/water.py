...
class WaterNode(Node):
    ...
    def start(self):
        ...
        while True:
            # DEBUG: topic_base = actor.envactor.water
            ...
            msg = WaterMessage(
                ...
                type="WaterData",
                humidity=self.get_property_value("humidity"),
            )
            print(f"[WaterNode] Publishing to actor.envactor.water.{self.actor_id}: {msg.model_dump()}")
