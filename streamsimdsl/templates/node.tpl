...
from streamsimdsl.utils.collisions import detect_collisions
...
class {{ thing_name }}Node(Node):
    def __init__(self, {{ id_field }}: str = "", parent_topic: str = "", *args, **kwargs):
        ...
        {% for posed_sensor in obj.sensors %}
            {% set node_type = posed_sensor.ref.subtype if posed_sensor.ref.subtype is defined and posed_sensor.ref.subtype else posed_sensor.ref.type %}
    ...
    def _run_loop(self):
        ...
        while self.running:
            ...
            setattr(self, "value", extracted_value)
            self._sim_data = {"value": extracted_value}
            {% endif %}
