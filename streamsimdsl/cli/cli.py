...
t2e_output_dir = r'C:\thesis\streamsimdsl\generated_files'

@click.group("streamsimdsl")
@click.pass_context
def cli(ctx):
...
# [*] How to run the cli:
# simulator: python -m streamsimdsl.generated_files.environments.
# validate: python -m streamsimdsl.cli.cli validate streamsimdsl/models/things/
# t2e: python -m streamsimdsl.cli.cli t2e streamsimdsl/models/things/
# t2d: python -m streamsimdsl.cli.cli t2d streamsimdsl/models/things/
# t2c: python -m streamsimdsl.cli.cli t2c streamsimdsl/models/things/
# t2vc: python -m streamsimdsl.cli.cli t2vc streamsimdsl/models/things/
