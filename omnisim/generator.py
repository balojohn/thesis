...
from .lang.utils import build_model
...
if __name__ == "__main__":
    ...
    if len(argv) < 3:
        print("Usage: python -m omnisim.generator omnisim/models/entities/MyEntities.ent omnisim/models/communication/MyComms.comm")
    else:
